...
const sampleData = [
  {roll: 'SLTC-101', year: '2025', name: 'Ramesh Kumar', father: 'Sh. Mohan Lal', mother: 'Smt. Rekha Devi',
    subjects: [
      {name:'Computer Fundamentals', theory:78, practical:12, theoryMax:80, practicalMax:20},
      {name:'MS Office', theory:85, practical:10, theoryMax:80, practicalMax:20}
    ]
  },
  {roll: 'SLCTC-102', year: '2025', name: 'Sita Verma', father: 'Sh. Rajesh Verma', mother: 'Smt. Meena Verma',
    subjects: [
  ...
  {roll: 'SLCTC-201', year: '2024', name: 'Amit Singh', father: 'Sh. Vinod Singh', mother: 'Smt. Lata Singh',
    subjects: [
